...
function makeparameters(sets, options, hourinfo)
    ...
    transmissioncostdata = connected .* (15 .+ 0.01*distances) .+ connectedoffshore .* (15 .+ 0.01*distances)
    ...
    techtable = [
        ...
        :battery        1000         0.1             1.5         10          0.9         1   # 1h discharge time, 150 €/kW = 150 €/kWh
        :pv             323         0               8           25          1           1
        :pvroof         423         0               6           25          1           1
        :csp            37460        2.9             56          30          1           1   # for solar multiple=3, storage=12 hours
