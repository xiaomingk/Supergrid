...
defaultoptions() = Dict(
    ...
    :discountrate => 0.05,
    :maxbioenergy => 0.02,              # max share of biofuel of annual regional electricity demand (assuming CCGT, less if GT)
    :maxdemandresponse => 0.03,         # max share of demand response of hourly regional electricity demand
    :hydrogendemand => 0,               # The share of hydrogen demand of annual regional electricity demand
    :nuclearallowed => true,
